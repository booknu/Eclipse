 ...
 *
 */
public class ModExpensesFrame extends JFrame{
	 ...
	 */
	public ModExpensesFrame(int year, int month, int date, Expenses exp)
	{
		this.exp = exp;
		...
		expenseField = new JTextField(exp.getExpense() + "");
		contentArea = new JTextField(exp.getRemarks());
	...
	private void setCompsInContentPanel()
	{
		...
		expenseField.setText(exp.getExpense() / 100 + "");
	...
	class FieldKeyListener extends KeyAdapter 
	{
		...
		public void keyPressed(KeyEvent e)
		{
			if(e.getKeyCode() == KeyEvent.VK_ENTER)
			{
				...
				if(contentArea.getText().equals(exp.getRemarks()))
					contentArea.setText("");
			}
		...
		public void mouseClicked(MouseEvent e) {
			...
			if(firstClick)
			{
				if(e.getSource() instanceof JTextField)
				{
					...
					if(txta.getText().equals(exp.getRemarks()))
						txta.setText("");
					firstClick = false;
				}
			}
